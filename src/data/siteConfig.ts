...
export interface SiteConfig {
  ...
  projects: {
    title: string;
    category: string;
    tools: string; // <-- Added back to prevent GitHub build errors
    image: string;
    description: string;
  }[];
}
  ...
  projects: [
    {
      ...
      tools: "", // <-- Left blank so it doesn't show up on the site
...
// Bumped to v3 to force everyone's browsers to update to your new links
